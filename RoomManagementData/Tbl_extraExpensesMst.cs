...
namespace RoomManagementData
{
    ...
    public partial class Tbl_extraExpensesMst: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        {
            get { return _extraItemName; }
            set
            {
                if (_extraItemName != value)
                {
                    _extraItemName = value;
                    OnPropertyChanged("extraItemName");
                }
            }
        }
        private string _extraItemName;
